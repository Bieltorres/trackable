...
import { Settings, Book, Video, CreditCard, Users, CheckCircle, PlusCircle, Copy, Play, Folder, BookOpen, Upload, Save, Eye, Edit3, Trash2 } from 'lucide-react'
...
export function AdminConfigModal({
  ...
  const paymentPlatformsConfig = {
    stripe: {
      name: 'Stripe',
      logo: '/images/payments/stripe-logo.png',
    },
    ticto: {
      name: 'Ticto',
      logo: '/images/payments/ticto-logo.png',
    },
  }
        ...
        <div className="flex-grow overflow-hidden">
          ...
          >
            ...
            <div className="flex-grow overflow-auto p-1">
              ...
              <TabsContent value="video-streaming" className="mt-4">
              ...
              <TabsContent value="student-management" className="mt-4">
                <p>Gerenciamento de Alunos - Conteúdo aqui.</p>
              </TabsContent>
            </div>
          </Tabs>
        </div>
